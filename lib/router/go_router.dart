...
import 'package:upturn_dashboard/pages/revenue/revenue_entry.dart';
import 'package:upturn_dashboard/pages/revenue/revenue_list.dart';
  ...
  routes: [
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: '/revenue/entry',
          builder: (context, state) => const RevenueEntryPage(),
        ),
        GoRoute(
          path: '/revenue/list',
